# Generated by Django 4.2.1 on 2023-06-23 22:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='businesses_in_category', to='business_directory.business')),
        ...
        migrations.AddField(
            model_name='business',
            name='categories',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(help_text='A comma-separated list of tags.', through='business_directory.Category', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddField(
            model_name='business',
