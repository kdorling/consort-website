# Generated by Django 4.2.1 on 2023-06-23 18:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='FeaturedEvent',
            fields=[
                ('onetimeevent_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='events.onetimeevent')),
            ],
            options={
                'abstract': False,
            },
            bases=('events.onetimeevent',),
        ),
    ]
